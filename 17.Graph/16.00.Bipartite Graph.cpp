 ...
 * - Use BFS to attempt coloring nodes with two colors (0 and 1).
 *
 * Intuition:
 ...
 * - If BFS finishes without conflicts for all components, return true.
 *
 * Edge Cases:
 ...
 *
 * Space Complexity:
 * - O(N + M) for adjacency list, O(N) for color array, O(N) for BFS queue.
 */
...
// ---------------------------
// BFS Function to Check Bipartiteness from a Node
// ---------------------------
